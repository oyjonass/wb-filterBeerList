...
export default {
    ...
    computed: {
        ...
        getBeerTypes() {
                ...
                _.forEach(typeBeerData, function (beertype) {
                    ...
                    const beersWithType = _.filter(items,
                        (beer) =>
    ...
    watch: {
        ...
        $route(to) {
            ...
            if (!_.isEqual(_.sortBy(this.selectedBeerType), _.sortBy(currentQueryString))) {
    ...
    methods: {
        ...
        beerTypeFilter(beertype) {
            ...
            if (!_.isEqual(_.sortBy(this.selectedBeerType), _.sortBy(currentQueryString))) {
                ...
                if (this.selectedBeerType.length < 1 || this.selectedBeerType == undefined) {
